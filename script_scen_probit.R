...
# Save to an RDS file
saveRDS(save_data, file = "scenario1_probit.rds")
...
# Save to an RDS file
saveRDS(save_data, file = "scenario2_probit.rds")
...
# Save to an RDS file
saveRDS(save_data, file = "scenario3_probit.rds")
...
# Save to an RDS file
saveRDS(save_data, file = "scenario4_probit.rds")
